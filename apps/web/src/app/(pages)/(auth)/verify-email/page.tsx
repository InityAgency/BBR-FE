...
export default function VerifyEmailPage() {
    ...
    const handleResendVerification = async () => {
        ...
        setIsLoading(true);
        try {
            const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/${process.env.NEXT_PUBLIC_API_VERSION}/auth/resend-verification`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
        ...
        <div className="flex items-center justify-center w-full">
            <div className="w-full py-6 lg:p-8">
                <div className="flex flex-col gap-3 mb-1">
                    ...
                    <h1 className="text-4xl font-bold text-left lg:text-left">Verify your email to proceed</h1>
