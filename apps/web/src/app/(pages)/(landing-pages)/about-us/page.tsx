    ...
    <div>
      ...
      <div className="flex flex-col items-center rounded-b-xl bg-secondary max-w-[calc(100svw-1.5rem)] 2xl:max-w-[calc(100svw-4rem)] mx-auto px-4 lg:px-12 py-12 gap-4 xl:gap-12 mb-20">
        <div className="flex flex-col gap-6 w-full rounded-xl bg-black/50 p-4 lg:p-8 py-12 lg:py-32 relative overflow-hidden">
          ...
          />
          <div className="flex flex-col align-center gap-[20px] z-10">
      ...
      {/* SECOND SECTION */}
      <div className="relative max-w-[calc(100svw-7.5rem)] 2xl:max-w-[calc(100svw-4rem)] mx-auto mb-20">
        <div className="flex flex-col gap-4 bg-secondary rounded-xl p-4 lg:p-12 w-full h-[485px] sm:h-[350px] md:h-[400px]">
      ...
      {/* THIRD SECTION */}
      <div className="flex flex-col sm:flex-col lg:flex-row gap-16 mx-5 md:mx-[200px] 2xl:mx-[274px] mb-20">
        <Image
          src="/bbr-founder.png"
          alt="why-we-exist"
          width={1000}
      ...
      {/* FOURTH SECTION */}
      <div className="flex flex-col bg-secondary p-4 lg:p-12 mb-40">
        ...
        <p className="text-md lg:text-lg w-full lg:w-[50%] text-left lg:text-center mx-auto text-white mb-5">
          I created this platform to bring transparency and quality into the
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 w-full">
          <div className="grid grid-cols-1 lg:grid-cols-1 gap-8 w-full mt-12 mb-8">
          ...
          <div>
            ...
            <Image
              ...
              width={450}
              height={240}
              className="-translate-y-1/2 mx-auto mb-20"
            />
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-1 gap-8 w-full mt-12 mb-8 mt-40 sm:mt-10">
            <div className="flex flex-col justify-center w-full custom-card rounded-2xl p-6 border">
              <div className="flex flex-row gap-4 items-center mb-4">
                <div className="relative">
                  <svg
      ...
      {/* SIXTH SECTION */}
      <div className="flex max-w-[calc(100svw-3.25rem)] 2xl:max-w-[calc(100svw-7.5rem)] mx-auto flex-col gap-6 w-full rounded-xl bg-black/50 p-4 lg:p-8 py-12 lg:py-32 relative overflow-hidden mb-[80px]">
        <Image
        ...
        <div className="flex flex-col align-center gap-[20px] z-10">
          ...
          <div className="flex gap-[8px] place-self-start lg:place-self-center">
            ...
            <Button variant="whiteOutline" onClick={() => {}} type="submit">
              Contact Our Team
            </Button>
          </div>
        </div>
      ...
      {/* SEVENTH SECTION */}
      <div className="flex flex-col bg-secondary  p-4 lg:p-12 mb-20">
        <span className="text-md lg:text-lg text-left lg:text-center text-primary w-full">
          WHO WE SERVE
        </span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 w-full mt-12 mb-8">
          ...
          <div className="flex flex-col justify-center w-full custom-card rounded-2xl p-6 border">
            <div className="flex flex-row gap-4 items-center mb-4">
              ...
              <p className="text-2xl font-bold">Developers & Brands</p>
            </div>
          ...
          <div className="flex flex-col justify-center w-full custom-card rounded-2xl p-6 border">
            <div className="flex flex-row gap-4 items-center mb-4">
              ...
              <p className="text-2xl font-bold">Explorers</p>
            </div>
