...
export default function ContinentsBestResidencesClient() {
    ...
    const categoryTypeId = '6e83bbd6-7363-4ec8-82b1-73e288ec17f6'; // Continents ID
        ...
        return (
            <div>
                <div className="flex flex-col items-center rounded-b-xl bg-secondary max-w-[calc(100svw-1.5rem)] 2xl:max-w-[calc(100svw-4rem)] mx-auto px-4 lg:px-12 py-12 gap-4 xl:gap-12 mb-12">
                    <div className="w-full xl:max-w-[1600px] mx-auto">
                        <div className="page-header flex flex-col gap-6 w-full lg:w-1/2 mx-auto ms-0">
                            <p className="text-md uppercase text-left text-primary">EXPLORE BY GEOGRAPHICAL AREA</p>
                            <h1 className="text-4xl font-bold text-left">Best Branded Residences by Continents</h1>
                        </div>
                    </div>
                </div>
                <SectionLayout>
                ...
                <div className="w-full xl:max-w-[1600px] mx-auto">
                    <div className="page-header flex flex-col gap-6 w-full lg:w-1/2 mx-auto ms-0">
                        ...
                        <h1 className="text-4xl font-bold text-left">
                            Best Branded Residences by Continents
                        </h1>
                        <p className="text-lg text-white/80">
                            Discover the best branded residences across different continents and explore luxury living opportunities worldwide.
                        </p>
                    </div>
                </div>
            </div>
