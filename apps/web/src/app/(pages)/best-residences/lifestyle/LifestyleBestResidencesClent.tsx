...
export default function LifestyleBestResidencesClient() {
    ...
    const categoryTypeId = '13680189-a51c-4751-be48-5c283241588a'; // Lifestyle ID
    ...
    const fetchData = useCallback(async (page: number) => {
        ...
        try {
            ...
            if (!response.ok) {
                throw new Error(`Failed to fetch lifestyle categories: ${response.status}`);
            }
            ...
            console.error('Error fetching lifestyle categories:', err);
        ...
        return (
            <div>
                <div className="flex flex-col items-center rounded-b-xl bg-secondary max-w-[calc(100svw-1.5rem)] 2xl:max-w-[calc(100svw-4rem)] mx-auto px-4 lg:px-12 py-12 gap-4 xl:gap-12 mb-12">
                    <div className="w-full xl:max-w-[1600px] mx-auto">
                        <div className="page-header flex flex-col gap-6 w-full lg:w-1/2 mx-auto ms-0">
                            <p className="text-md uppercase text-left text-primary">CURATED LIVING EXPERIENCES</p>
                            <h1 className="text-4xl font-bold text-left">Best Branded Residences by Lifestyle</h1>
                        </div>
                    </div>
                </div>
                <SectionLayout>
                ...
                <div className="w-full xl:max-w-[1600px] mx-auto">
                    <div className="page-header flex flex-col gap-6 w-full lg:w-1/2 mx-auto ms-0">
                        ...
                        <h1 className="text-4xl font-bold text-left">
                            Best Branded Residences by Lifestyle
                        </h1>
                        <p className="text-lg text-white/80">
                            Discover residences tailored to your lifestyle preferences and find luxury living experiences that match your unique needs.
                        </p>
                    </div>
                </div>
            </div>
