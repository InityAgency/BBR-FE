...
const TabContent = ({
  ...
  return (
    <div className="flex gap-[64px] mt-[52px] items-center">
      <div className="flex flex-col gap-[36px] w-[50%]">
        <div>
          <h1 className="text-black text-[20px] text-[42px] !font-medium">
            {primaryTitle}
          </h1>
          <p className="text-black/60">{primaryDescription}</p>
        </div>
        <div>
          <h2 className="text-black text-[30px] !font-medium">
            {secondaryTitle}
          </h2>
          <p className="text-black/60">{secondaryDescription}</p>
        </div>
      </div>
      <Image
        src={imageUrl}
  ...
  return (
    <div>
      ...
      <div className="flex flex-col items-center rounded-b-xl bg-secondary max-w-[calc(100svw-1.5rem)] 2xl:max-w-[calc(100svw-4rem)] mx-auto px-4 lg:px-12 py-12 gap-4 xl:gap-12 mb-8 lg:mb-0">
        <div className="flex flex-col gap-6 w-full rounded-xl bg-black/50 p-4 lg:p-8 py-12 lg:py-[50px] relative overflow-hidden">
          <Image
          ...
          />
          <div className="flex justify-between z-10 gap-[140px]">
            ...
            <div className="h-[541px] w-[626px] bg-red-100"></div>
          </div>
        </div>
      </div>

      {/* SECOND SECTION */}
      <div className="py-[80px] px-[195px] bg-beigeVariant4">
        <p className="text-primary text-[20px] tracking-widest text-center">
          WHY CHOOSE BEST BRANDED RESIDENCES?
        </p>
        <h1 className="text-[52px] text-black place-self-center text-center w-[70%]">
          Align Your Development with the Industry Leader in Luxury Branded
          Residences
        </h1>
        <div className="flex bg-beigeVariant5 mt-[56px] rounded-2xl p-[48px] gap-[32px]">
          <Image
          ...
          <div className="flex flex-col justify-between gap-[20px] w-[50%]">
            ...
            <div className="flex bg-beigeVariant6 p-[22px] gap-[16px] rounded-xl">
              ...
              <div>
                ...
                <p className="text-black/80 text-[20px]">
                  Secure premium pricing and greater demand by aligning with our
                  ranking system, driving unmatched visibility and credibility
                  for your property.
                </p>
              </div>
            </div>
            ...
            <div className="flex bg-beigeVariant6 p-[22px] gap-[16px] rounded-xl">
              ...
              />
              <div>
                <h2 className="text-black text-[28px]">Expand Global Reach</h2>
                <p className="text-black/80 text-[20px]">
      ...
      {/* THIRD SECTION */}
      <div className="flex flex-col gap-[56px] bg-beigeVariant8 border-3 border-beigeVariant7 px-[120px] py-[80px]">
        <div className="flex gap-[100px]">
          <div className="w-[50%]">
            <p className="text-primary">WHY THEY CHOOSE US</p>
            <h1 className="text-[52px] text-black">
              Why Developers Choose BBRA Strategic Necessity
            </h1>
          </div>
          <p className="text-black/70 text-[20px] w-[50%]">
            Lorem Ipsum is simply dummy text of the printing and typesetting
            industry. Lorem Ipsum has been the industry's standard dummy text
            ever since the 1500s, when anLorem Ipsum is simply dummy text of the
            printing and typesetting industLorem Ipsum is simply dummy text of
            the printing and typesetting industry. Lorem Ipsum has been the
            industry's standard dummy text ever since the 1500s, when anLorem
            Ipsum is simply dummy text of the printing and typesetting indust
          </p>
        </div>
        <Image
        ...
        />
        <div className="grid grid-cols-2 lg:grid-cols-3 grid-rows-3">
          ...
          <div className="flex bg-beigeVariant6 p-[22px] gap-[16px] lg:border-r-3 lg:border-beigeVariant5">
            ...
            <div>
              ...
              <p className="text-black/80 text-[20px]">
                Our developers consistently achieve premium pricing and reduced
                marketing costs, resulting in a higher return on investment.
              </p>
            </div>
          </div>
          ...
          <div className="flex bg-beigeVariant6 p-[22px] gap-[16px] lg:border-r-3 lg:border-beigeVariant5">
            ...
            <div>
              ...
              <p className="text-black/80 text-[20px]">
                By aligning with BBR, developers position themselves to succeed
                not just today, but in the future. Our team continually monitors
                market
              </p>
            </div>
          </div>
      ...
      {/* FOURTH SECTION */}
      <div className="bg-beigeVariant8 py-[80px] px-[300px]">
        <h1 className="text-black text-[52px] text-center">Our Core team</h1>
        <p className="text-black text-[20px] text-center">
          Lorem Ipsum is simply dummy text of the printing and typesetting
          industry
        </p>
        <div className="relative flex gap-[48px] mt-[20px]">
          <div className="flex flex-col gap-[10px]">
            ...
            <h1 className="text-black text-center text-[36px]">Robert Fox</h1>
            <p className="text-black/60 text-center text-[20px]">
              Software Developer
            </p>
          </div>
          ...
          <div className="flex flex-col gap-[10px]">
            ...
            <h1 className="text-black text-center text-[36px]">Jenny Wilson</h1>
            <p className="text-black/60 text-center text-[20px]">
              Software Tester
            </p>
          </div>
      ...
      {/* FIFTH SECTION */}
      <div className="bg-beigeVariant8 py-[80px] px-[120px] border-3 border-beigeVariant7">
        <div className="flex flex-col w-[50%] place-self-center">
          <p className="text-primary text-[20px] text-center">
            WHY THEY CHOOSE US
          </p>
          <h1 className="text-black text-[52px] text-center">
            Why Developers Choose BBRA Strategic Necessity
          </h1>
          <p className="text-black/60 text-[20px] text-center">
            Lorem Ipsum is simply dummy text of the printing and typesetting
            industry. Lorem Ipsum has been the industry's standard dummy text
            ever
          </p>
        </div>
        <CustomTabs tabs={tabs} className="mt-[56px]" />
      </div>

      {/* SIXTH SECTION */}
      <div className="px-[120px] py-[80px] bg-beigeVariant4">
        <div className="relative flex flex-col gap-[20px] bg-beigeVariant6 rounded-xl py-[66px] items-center">
          <Image
            src="/texture.png"
            alt="about-us"
            fill
            className="w-full h-full object-cover opacity-40"
          />
          <h1 className="text-black text-[52px] w-[50%] text-center">
            Join the Best and Elevate Your Branded Residence
          </h1>
          <p className="text-black text-[18px] w-[50%] text-center">
          ...
          <Link
            href="/#"
            className="z-10 inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all bg-primary text-primary-foreground shadow-xs hover:bg-primary/90 h-9 px-[40px] py-[20px] has-[>svg]:px-3 w-fit"
          >
            Get Started -&gt;
          </Link>
        </div>
