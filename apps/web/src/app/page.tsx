    ...
    <>
      ...
      <div className="bg-secondary">
        <div className="flex flex-col lg:flex-col gap-4 max-w-[calc(100svw-3rem)] 2xl:max-w-[90svw] mx-auto px-4 lg:px-12 py-24 gap-4 xl:gap-8 mb-12">
           ...
           <div className="flex flex-col lg:flex-row gap-4 mt-16 max-w-[85%] mx-auto">
             <div className="flex flex-row gap-4 items-center w-full">
              <div>
                ...
                <div className="flex flex-col gap-2">
                  <h3 className="text-2xl font-bold">Trusted Rankings</h3>
             ...
             <div className="flex flex-row gap-4 items-center w-full">
              <div>
                ...
                <div className="flex flex-col gap-2">
                  <h3 className="text-2xl font-bold">Informed Decisions</h3>
           ...
           <div className="flex flex-col lg:flex-row gap-4 mt-16 border border-zinc-700/80 rounded-2xl p-6 relative">
             <Image src="/ranking-criteria-1.webp" alt="Ranking Image" width={1000} height={1000} className="w-full rounded-xl object-cover" />
             <Image src="/ranking-criteria-2.webp" alt="Ranking Image" width={1000} height={1000} className="w-full rounded-xl object-cover" />
             <Image src="/ranking-criteria-3.webp" alt="Ranking Image" width={1000} height={1000} className="w-full rounded-xl object-cover" />
             <Image src="/stats.png" alt="Ranking Image" width={1000} height={1000} className="w-[57%] rounded-xl object-contain absolute -bottom-10 left-55" />
           </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-16">
          ...
          <div className="flex flex-col justify-center w-full bg-zinc-500/10 rounded-2xl p-6">
            <div className="flex flex-row gap-4 items-center mb-4">
              ...
              <span className="absolute -top-2 -left-2 rounded-full bg-white/10 w-12 h-12"></span>
                <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" fill="none">
                  <path d="M42 42H15.6C12.2397 42 10.5595 42 9.27606 41.346C8.14708 40.7708 7.2292 39.8529 6.65396 38.7239C6 37.4405 6 35.7603 6 32.4V6M12 30L20 22L28 30L40 18M40 18V26M40 18H32" stroke="white" strokeWidth="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
              </div>
