          ...
          <div className="flex flex-col lg:flex-row gap-4 lg:gap-8 xl:gap-24 items-center px-4 py-12 lg:px-0 lg:py-0 xl:max-w-[1600px] mx-auto">
            <div className="w-full">
              ...
              <div className="flex gap-2 flex-wrap">
                <Link href="/matchmaking-tool" className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all bg-primary text-primary-foreground shadow-xs hover:bg-primary/90 h-9 px-4 py-2 has-[>svg]:px-3 w-full lg:w-fit ">
                  Get matched
