  ...
  return (
    <>
      ...
      <section className="exclusive-offers bg-secondary">
        <SectionLayout>
            <div className="flex flex-col lg:flex-row gap-4 lg:gap-8 items-center px-4 py-12 lg:px-0 lg:py-0">
      ...
      <section className="blog-section px-4 py-12 lg:px-0">
        <SectionLayout>
          <div className="blog-section-header flex flex-col lg:flex-row w-full items-end gap-4 lg:gap-0">
          ...
          <div className="blgo-section-content mt-8">
            <LatestPosts />
          </div>
        </SectionLayout>
      </section>

      <section className="brand-slider px-4 lg:px-0">
        <SectionLayout>
      ...
      <section className="get-in-touch px-4 lg:px-0 bg-secondary">
        <SectionLayout>
          <div className="border rounded-xl w-full p-4 lg:p-8 flex flex-col lg:flex-row gap-8">
      ...
      <section className="section-with-badge px-4 lg:px-0 bg-secondary">
        <SectionLayout>
          <div className="flex flex-col items-start items-center gap-4 bg-[#FAF3EE] rounded-2xl p-6 lg:py-12 relative">
