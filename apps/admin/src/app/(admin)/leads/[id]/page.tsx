...
import { Trash2, Mail, Phone, Eye, Calendar } from "lucide-react";
    ...
    return (
        <AdminLayout>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                {/* Lead info */}
                <div className="bg-card rounded-lg p-6 border border-border">
                    <h2 className="text-lg font-semibold mb-4">User Account Preferences</h2>
                    {user ? (
                        <>
                            <div className="mb-2 flex w-full gap-4">
                                <div className="w-1/2">
                                    <div className="text-xs text-muted-foreground">Full Name</div>
                                    <div className="font-medium text-sm">{user.fullName || 'Not specified'}</div>
                                </div>
                                <div className="w-1/2">
                            ...
                            <div className="mb-2 flex w-full gap-4">
                                <div className="w-1/2">
                                    ...
                                    <div className="font-medium text-sm">{user.emailVerified ? 'Yes' : 'No'}</div>
                                </div>
                                <div className="w-1/2">
                            ...
                            <div className="mb-2 flex w-full gap-4">
                                <div className="w-1/2">
                                    ...
                                    <div className="font-medium text-sm">{user.company || 'Not specified'}</div>
                                </div>
                            </div>
                        </>
                    ) : (
                ...
                <div className="bg-card rounded-lg p-6 border border-border lg:col-span-2">
                    ...
                    {lead.requests && lead.requests.length > 0 ? (
                        ...
                        <div className="text-center py-8 text-muted-foreground">
                            No requests found for this lead.
                        </div>
                    )}
                </div>
            </div>
